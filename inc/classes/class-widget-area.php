...
if ( ! class_exists( 'Fashion_daily_Widget_Area' ) ) {

	class Fashion_daily_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'fashion_daily-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'fashion_daily-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'fashion_daily-theme/widget_area/classes', $classes, $area_id );
	...
	function fashion_daily_widget_area() {
		return Fashion_daily_Widget_Area::get_instance();
	}

	fashion_daily_widget_area();
}
