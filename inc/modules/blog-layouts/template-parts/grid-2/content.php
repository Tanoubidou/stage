...
<article id="post-<?php echo esc_attr( the_ID() ); ?>" <?php post_class( 'posts-list__item grid-item grid-item-2' ); ?>>
	<div class="posts-list__item-inner">
		
		<div class="post-thumbnail_bg" <?php fashion_daily_post_overlay_thumbnail(); ?>></div>
