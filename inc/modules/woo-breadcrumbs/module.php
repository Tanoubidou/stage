...
if ( ! class_exists( 'Fashion_daily_Woo_Breadcrumbs_Module' ) ) {

	/**
	 * Define Fashion_daily_Woo_Breadcrumbs_Module class
	 */
	class Fashion_daily_Woo_Breadcrumbs_Module extends Fashion_daily_Module_Base {
		...
		public function get_wc_breadcrumbs( $is_custom_breadcrumbs, $args ) {
			...
			$wc_breadcrumbs = new Fashion_daily_WC_Breadcrumbs( $args );
