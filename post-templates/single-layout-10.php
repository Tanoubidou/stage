...
<?php get_template_part( 'template-parts/single-post/layout-10/single-feature-header', $pf ) ?>
			...
			<div id="primary" <?php fashion_daily_primary_content_class(); ?>>
				...
				<main id="main" class="site-main"><?php
					while ( have_posts() ) : the_post();
						...
						get_template_part( 'template-parts/single-post/layout-10/content', 'post' );
