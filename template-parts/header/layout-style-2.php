...
<div <?php fashion_daily_header_class(); ?>>
	...
	<div class="space-between-content">
		...
		<?php fashion_daily_main_menu_toggle(); ?>
	...
	<div class="header-vertical-menu-popup">
		<div class="header-vertical-menu-popup__inner">
			<button class="menu-toggle-close btn-initial"><?php echo fashion_daily_get_icon_svg( 'close' ); ?></button>
			<?php fashion_daily_main_menu( 'vertical' ); ?>
		</div>
	</div>
