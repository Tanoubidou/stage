	...
	class CX_Interface_Builder {
		...
		public function enqueue_assets() {
			...
			wp_enqueue_script(
				...
				get_theme_file_uri( '/framework/modules/interface-builder/assets/js/cx-interface-builder' . $suffix . '.js' ),
				$js_deps,
				$this->version,
				true
			);
			...
			wp_enqueue_style(
				'cx-interface-builder',
				get_theme_file_uri( '/framework/modules/interface-builder/assets/css/cx-interface-builder.css' ),
				$css_deps,
				$this->version,
				'all'
			);
