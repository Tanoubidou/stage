...
if ( ! class_exists( 'CX_Control_Select' ) ) {
	...
	class CX_Control_Select extends CX_Controls_Base {
		...
		public function register_depends() {
			wp_register_script(
				'cx-select2',
				get_theme_file_uri( '/framework/modules/interface-builder/assets/lib/select2/select2.min.js' ),
				array( 'jquery' ),
				'4.0.5',
				true
			);
			...
			wp_register_style(
				'cx-select2',
				get_theme_file_uri( '/framework/modules/interface-builder/assets/lib/select2/select2.min.css' ),
				array(),
				'4.0.5',
				'all'
			);
